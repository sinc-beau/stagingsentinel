...
export function WatchtowerForumLasVegasContent() {
  return (
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-3 text-slate-300">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-base font-semibold">May 17-19, 2026</span>
                  </div>
                  <div className="flex items-center gap-2">
    ...
    <section className="py-24 bg-gradient-to-b from-slate-900 to-black">
      <div className="max-w-7xl mx-auto px-8 lg:px-16">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <p className="text-xl text-slate-300 mb-6 leading-relaxed">
              Experience world-class hospitality in the entertainment capital of the world.
              The M Resort provides the perfect setting for focused collaboration and networking.
            </p>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-teal-400 flex-shrink-0 mt-1" />
                <div className="text-slate-300">
                  <strong className="text-white">Prime Location:</strong> Easy access to Harry Reid International Airport
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-teal-400 flex-shrink-0 mt-1" />
    ...
    <section id="registration" className="py-24 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-8 lg:px-16">
        ...
        <div className="bg-gradient-to-br from-slate-900/90 to-black/90 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 lg:p-12 shadow-2xl">
          <DynamicForumForm
            formId="facfe5ba-9504-4c97-abfb-d694b65ece96"
            portalId="45377644"
            region="na1"
          />
        </div>
  ...
  return (
    <section className="py-32 bg-gradient-to-br from-slate-900 via-black to-slate-900 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-8 lg:px-16 text-center">
        <div className="mb-8">
          <div className="text-xs font-mono text-teal-400 tracking-wider mb-4">MAY 17-19, 2026</div>
          <h2 className="text-5xl lg:text-6xl font-black text-white mb-6">
            Your Mission Awaits
          </h2>
