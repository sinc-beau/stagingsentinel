...
export function WatchtowerForumMiamiContent() {
  return (
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-3 text-slate-300">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-base font-semibold">May 31 - June 2, 2026</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <MapPin className="w-4 h-4 text-teal-400" />
                    <span className="text-base font-semibold">Doral Creek Hotel, Miami, FL</span>
                  </div>
                </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            ...
            <div className="relative h-[500px] bg-slate-800/50 rounded-2xl border border-slate-700 overflow-hidden">
              <img
                src="/trumpdoral.png"
                alt="Doral Creek Hotel, Miami, FL"
          ...
          <div>
            <p className="text-xl text-slate-300 mb-6 leading-relaxed">
              Experience world-class hospitality in the heart of Miami's dynamic business district.
              The Doral Creek Hotel provides the perfect setting for focused collaboration and networking.
            </p>
            <div className="space-y-4">
    ...
    <section id="registration" className="py-24 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-8 lg:px-16">
        ...
        <div className="bg-gradient-to-br from-slate-900/90 to-black/90 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 lg:p-12 shadow-2xl">
          <DynamicForumForm
            formId="97d64580-d140-4d40-b208-7bde721f7734"
            portalId="45377644"
            region="na1"
          />
        </div>
      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-16">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-amber-500/10 border border-amber-500/30 px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-xs font-mono text-amber-400 tracking-wider uppercase">Gold Sponsor</span>
          </div>
          <h2 className="text-3xl lg:text-4xl font-black text-white mb-4">
  ...
  return (
    <section className="py-32 bg-gradient-to-br from-slate-900 via-black to-slate-900 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-8 lg:px-16 text-center">
        <div className="mb-8">
          <div className="text-xs font-mono text-teal-400 tracking-wider mb-4">MAY 31 - JUNE 2, 2026</div>
          <h2 className="text-5xl lg:text-6xl font-black text-white mb-6">
            Your Mission Awaits
          </h2>
