        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <div className="text-2xl text-teal-400 font-bold mb-8">Miami, Florida</div>

              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 text-slate-300 mb-8">
                <div className="flex items-center gap-2">
                  <Calendar className="w-5 h-5 text-teal-400" />
                  <span className="text-lg font-semibold">May 31 - June 2, 2026</span>
                </div>
                <div className="flex items-center gap-2">
                  <MapPin className="w-5 h-5 text-teal-400" />
                  <span className="text-lg font-semibold">Trump Doral, Miami, FL</span>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-slate-900/90 to-black/90 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 lg:p-12 shadow-2xl flex justify-center">
              <div className="w-full max-w-2xl">
                <DynamicForumForm
                  formId="ad315598-0984-4ec8-9e26-8792058cee3b"
                  portalId="45377644"
                  region="na1"
                />
              </div>
